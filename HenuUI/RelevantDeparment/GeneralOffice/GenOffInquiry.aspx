<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/GenOffMaster.Master" AutoEventWireup="true" CodeBehind="GenOffInquiry.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.GeneralOffice.GenOffInquiry" %>
    ...
    <table class="TableView" border="1">
                     ...
                     <tr>
                       ...
                       <td  align="left"  width="150">
                        ...
                        <td align="left" width="130">
                            ...
                            <asp:Button ID="btn_rsearch" runat="server" Text="查询" OnClick="Button1_Click"  width="50"/>
                        </td>
                     </tr>
                </table>
            </asp:Panel>
        ...
        <tr>
            <td colspan="7" align="left" class="TableViewtable">
                <asp:GridView ID="Grid_GenOffInquiry"  EmptyDataText="没有查询到符合条件的数据!" PageSize="15"  OnPageIndexChanging="Grid_AssManOffInquiry_PageIndexChanging1" runat="server" CellPadding="4" AllowPaging="True" GridLines="None" Width="800px" ForeColor="#333333" AutoGenerateColumns="False">
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        ...
                        <asp:BoundField HeaderText="申购部门名称" ItemStyle-HorizontalAlign="Center"  DataField="DeclareOrgName" ItemStyle-Width="10%" >
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="审批状态" ItemStyle-HorizontalAlign="Center" DataField="GuiKoOrgAuditState1"  ItemStyle-Width="10%">
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        ...
                        <asp:LinkButton ID="beian" Text="备案评审报告" runat="server" ItemStyle-HorizontalAlign="Center" ></asp:LinkButton>   
                        <asp:LinkButton ID="pchakan" Text="查看评审报告" runat="server" ItemStyle-HorizontalAlign="Center" ></asp:LinkButton> 
                        </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
               ...
               <%-- 如果该分页是首分页，那么该连接就不会显示了.同时对应了自带识别的命令参数CommandArgument--%>
                <asp:LinkButton ID="LinkButtonFirstPage" runat="server" CommandArgument="First" CommandName="Page" ForeColor="White"
                    Visible='<%#((GridView)Container.NamingContainer).PageIndex != 0 %>'>首页</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonPreviousPage" runat="server" CommandArgument="Prev" ForeColor="White"
                    CommandName="Page" Visible='<%# ((GridView)Container.NamingContainer).PageIndex != 0 %>'>上一页</asp:LinkButton>
               <%--如果该分页是尾页，那么该连接就不会显示了--%>
                <asp:LinkButton ID="LinkButtonNextPage" runat="server" CommandArgument="Next" CommandName="Page"  ForeColor="White"
                    Visible='<%# ((GridView)Container.NamingContainer).PageIndex != ((GridView)Container.NamingContainer).PageCount - 1 %>'>下一页</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonLastPage" runat="server" CommandArgument="Last" CommandName="Page" ForeColor="White"
              ...
              <%--  <asp:LinkButton ID="btnGo" runat="server" CausesValidation="False" CommandArgument="-2"
                    ...
                    <%--<SortedDescendingCellStyle BackColor="#D1DDF1" />--%>
