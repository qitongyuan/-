<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/GenOffMaster.Master" AutoEventWireup="true" CodeBehind="GenOffBacklog.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.GeneralOffice.GenOffBacklog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableAddProject" border="1">
        ...
        <tr class="TableAddProjectOther">
            <td colspan="7">
                <asp:GridView ID="Grid_GenOffBacklog" PageSize="15"  EmptyDataText="没有查询到符合条件的数据!" OnPageIndexChanging="Grid_DeclareDemand_PageIndexChanging" runat="server" AllowPaging="True" GridLines="None" Width="800px" AutoGenerateColumns="False" ForeColor="#333333" CellPadding="4">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="申购部门名称" DataField="DeclareOrgName" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="审批状态" DataField="GuikouOrgAuditState" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
