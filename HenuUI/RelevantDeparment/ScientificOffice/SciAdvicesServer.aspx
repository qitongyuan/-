<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SciOffMaster.Master" AutoEventWireup="true" CodeBehind="SciAdvicesServer.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.ScientificOffice.SciAdvicesServer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- <table class="CaiGouTable" border="1">
        <tr class="CaiGouTableCol2">
         ...
         <tr  class="CaiGouTableCol">
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">项目名称：</td>
            ...
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">申报单位：</td>
            <td colspan="3" style="border: thin groove #000000">
               <asp:TextBox ID="lb_DeclareOrgName" runat="server" Text="" Width="150px" Enabled="False"></asp:TextBox>
            </td>
        </tr>
         <tr class="CaiGouTableCol">
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">申报人：</td>
            <td colspan="3" style="border: thin groove #000000">
               <asp:TextBox ID="lb_Contact" runat="server" Text="" Width="110px" Enabled="False"></asp:TextBox>
            </td>
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">联系电话：</td>
            <td colspan="3" style="border: thin groove #000000">
               <asp:TextBox ID="lb_Phone" runat="server" Text="" Width="150px" Enabled="False"></asp:TextBox>
            </td>
        </tr>
         <tr class="CaiGouTableCol">
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">拟申请采购方式：</td>
            <td colspan="3" style="border: thin groove #000000">
                <asp:TextBox ID="lb_ProTypeName" runat="server" Text="" Width="110px" Enabled="False"></asp:TextBox>
            </td>
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">经费科目名称及编号：</td>
            <td colspan="3" style="border: thin groove #000000">
                <asp:TextBox ID="lb_FundingName" runat="server" Text="" Width="150px" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr class="CaiGouTableCol">
            <td style="border: thin groove #000000; background-color: #C0C0C0;" align="right">归口部门：</td>
            <td colspan="3" style="border: thin groove #000000">
    ...
    <div style="width: 800px; margin-bottom: 2px">
       ...
       <%-- <table class="CaiGouTable" border="1">
            ...
            <tr>
                <td colspan="2" align="left" style="border: thin groove #000000; background-color: #e8e8e8;">申请采购方式理由：</td>
    ...
    <div style="width: 800px; margin-bottom: 2px">
        ...
        <table class="CaiGouTable" border="1">
            ...
            <tr class="CaiGouTableCol2">
                <td colspan="8" align="left">归口部门科研处审批意见<font color="red">（必须在意见中填写未通过的理由，限50字以内）</font></td>
            </tr>
            <tr class="CaiGouTableCol">
                <td colspan="8" align="left">
