<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SciOffMaster.Master" AutoEventWireup="true" CodeBehind="SciOffBacklog.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.ScientificOffice.SciOffBacklog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableAddProject" border="1">
        ...
        <tr class="TableAddProjectOther">
            <td colspan="7">
                <asp:GridView ID="Grid_SciOffBacklog" EmptyDataText="没有查询到符合条件的数据!" PageSize="15" OnPageIndexChanging="Grid_DeclareDemand_PageIndexChanging" runat="server" AllowPaging="True" GridLines="None" Width="800px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField HeaderText="编号" DataField="DeclareId" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="申购表类型" DataField="DeclareType" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="项目名称" DataField="ProjectName" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="申购人" DataField="Contact" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="申购部门名称" DataField="DeclareOrgName" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="审批状态" DataField="ApprovalState" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
