<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SciOffMaster.Master" AutoEventWireup="true" CodeBehind="SciOffInquiry.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.ScientificOffice.SciOffInquiry" %>
    ...
    <table class="TableView" border="1">
        ...
        <tr>
            <td colspan="7" align="left" class="TableViewtable">
                 <asp:GridView ID="Grid_AssManOffInquiry"  EmptyDataText="没有查询到符合条件的数据!"  OnPageIndexChanging="Grid_AssManOffInquiry_PageIndexChanging1" runat="server" AllowPaging="True" PageSize="15" GridLines="None" Width="800px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333">
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        ...
                        <asp:BoundField HeaderText="审批状态" ItemStyle-HorizontalAlign="Center" DataField="GuiKoOrgAuditState1">
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
