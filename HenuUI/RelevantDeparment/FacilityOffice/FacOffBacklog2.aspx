<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FacOffMaster1Master.Master" AutoEventWireup="true" CodeBehind="FacOffBacklog2.aspx.cs" Inherits="UI.HenuUI.RelevantDeparment.FacilityOffice.FacOffBacklog2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableAddProject" border="1">
        ...
        <tr class="TableAddProjectOther">
            <td colspan="7">
                <asp:GridView ID="Grid_FacOffBacklog" EmptyDataText="没有查询到符合条件的数据!" OnPageIndexChanging="Grid_DeclareDemand_PageIndexChanging" AllowPaging="True" PageSize="15" runat="server" Width="800px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="GuiKoOrgAuditState2" HeaderText="审批状态" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
