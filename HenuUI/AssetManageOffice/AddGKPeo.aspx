<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AssManOffMaster.Master" AutoEventWireup="true" CodeBehind="AddGKPeo.aspx.cs" Inherits="UI.HenuUI.AssetManageOffice.DepartmentMessageManage.AddGKPeo" %>
    ...
    <table >
        <tr>
         ...
         <tr class="TableUserUpTopTr" >
            <td align="right" width="150" style="border: thin groove #000000; background-color: #e8e8e8; text-align:right;" >归口部门名称：
            </td>
      ...
      <tr class="TableUserUpTopTr">
            ...
            <td align="right"  width="200" >
                ...
                <asp:Button ID="Button2" runat="server" align="left" Text="上一步" OnClick="Button2_Click" />
