<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AssManOffMaster.Master" AutoEventWireup="true" CodeBehind="Depuserqx.aspx.cs" Inherits="UI.HenuUI.AssetManageOffice.Depuserqx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="TableView" border="1">
        ...
        <tr class="TableViewCol1Boss">
            <td colspan="9" align="left" class="TableViewCol1">分配部门</td>
        </tr>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="test1">
                    <table class="TableViewCol2Boss">
                        <tr>
                            ...
                            <td align="left" colspan="8" width="690">
                                <asp:TextBox ID="bumen" runat="server" Width="200"></asp:TextBox>
                            </td>
        ...
        <tr class="TableViewCol1Boss">
            <td colspan="9" align="left">权限分配</td>
           
        </tr>
    
        <tr class="TableViewCol2Boss">
            <td colspan="9" align="left">
               <asp:GridView ID="Grid_Depuserqx" runat="server" border="1"   AllowPaging="True" CellPadding="4" GridLines="None" Width="800px" AutoGenerateColumns="False" 
               EmptyDataText="没有查询到符合条件的数据!" ShowHeaderWhenEmpty="True" ForeColor="#333333"  >
